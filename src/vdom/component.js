...
export function renderComponent(component, opts, mountAll, isChild) {
    ...
    if (!skip) {
        ...
        if (typeof childComponent === 'function') {
            ...
            inst = initialChildComponent; // undefined
            ...
            if (initialBase || opts === SYNC_RENDER) {
                ...
                base = diff(cbase, rendered, context, mountAll || !isUpdate, initialBase && initialBase.parentNode, true); // 挂载
            }
        }
